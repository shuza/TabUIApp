...
public class FavoriteRewardListFragment extends ListFragment 
{
	private List<Row> rows;
	private List<Reward> favoriteRewardInfoList;        // ListView items list
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//rewardInfoList = TabActivity.favoriteRewardInfoList;

//        favoriteRewardInfoList = new ArrayList<Reward>();
//
//        for(Reward reward:TabActivity.rewardInfoList)
//        {
//            if(reward.getReward_favorite()==1)
//            {
//                favoriteRewardInfoList.add(reward);
//            }
//        }
...
//			getListView().setChoiceMode(ListView.CHOICE_MODE_SINGLE);
			...
			// Deafult Set All List
			RewardListAdapter adapter = prepareList(favoriteRewardInfoList);
