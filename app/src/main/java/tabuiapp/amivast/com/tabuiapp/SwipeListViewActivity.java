...
//			if (list.getAdapter().getItem(temp_position) instanceof Item) 
//			{
//				temp_position = temp_position - getSectionCounter(temp_position);
//			}
...
//	private int getSectionCounter(int pos)
//	{
//		int sectionCounter = 0;
//		
//		for(int i=0;i<pos;i++)
//		{
//			if (list.getAdapter().getItem(i) instanceof Section)
//			{
//				sectionCounter++;
//			}
//		}
